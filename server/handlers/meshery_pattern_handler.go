...
func (h *Handler) handleProviderPatternSaveError(rw http.ResponseWriter, eventBuilder *events.EventBuilder, userID coreV1.Uuid, body []byte, err error, provider models.Provider) {
...
func (h *Handler) handleProviderPatternGetError(rw http.ResponseWriter, eventBuilder *events.EventBuilder, userID coreV1.Uuid, body []byte, err error, provider models.Provider) {
