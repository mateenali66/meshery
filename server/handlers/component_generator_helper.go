...
func (h *Handler) sendSuccessResponse(rw http.ResponseWriter, userID core.Uuid, provider models.Provider, message string, errMsg string, response *models.RegistryAPIResponse) {
	if errMsg != "" {
		if message != "" {
...
func (h *Handler) sendErrorEvent(userID core.Uuid, provider models.Provider, description string, err error) {
...
func (h *Handler) sendFileEvent(userID core.Uuid, provider models.Provider, response *models.RegistryAPIResponse) {
...
func (h *Handler) sendEventForImport(userID core.Uuid, provider models.Provider, compsCount int, modelName string, isCsv bool) {
